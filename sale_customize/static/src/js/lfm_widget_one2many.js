...
var One2manyWidgetGraphRenderer = GraphRenderer.extend({
    /**
     * We want section and note to take the whole line (except handle and trash)
     * to look better and to hide the unnecessary fields.
     *
...
var SectionAndNoteFieldOne2Many = FieldOne2Many.extend({
    ...
    _getRenderer: function () {
        ...
        }else if(this.view.arch.tag === 'graph'){
           return One2manyWidgetGraphRenderer;
        }
...
fieldRegistry.add('lfm_widget_one2many', One2manyWidgetGraphRenderer);
